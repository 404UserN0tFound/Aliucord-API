...
async function get(data: RestOptions | string): Promise<RestResponse> {
  return new Promise((resolve, reject) => {
    window.aliucord.rest.get(data).then((response: RestResponse) => {
      resolve(response);
    }).catch((err: any) => {
      reject(err);
    });
...
async function post(data: RestOptions | string): Promise<RestResponse> {
  return new Promise((resolve, reject) => {
    window.aliucord.rest.post(data).then((response: RestResponse) => {
      resolve(response);
    }).catch((err: any) => {
      reject(err);
    });
...
async function put(data: RestOptions | string): Promise<RestResponse> {
  return new Promise((resolve, reject) => {
    window.aliucord.rest.put(data).then((response: RestResponse) => {
      resolve(response);
    }).catch((err: any) => {
      reject(err);
    });
...
async function patch(data: RestOptions | string): Promise<RestResponse> {
  return new Promise((resolve, reject) => {
    window.aliucord.rest.patch(data).then((response: RestResponse) => {
      resolve(response);
    }).catch((err: any) => {
      reject(err);
    });
...
async function _delete(data: RestOptions | string): Promise<RestResponse> {
  return new Promise((resolve, reject) => {
    window.aliucord.rest.delete(data).then((response: RestResponse) => {
      resolve(response);
    }).catch((err: any) => {
      reject(err);
    });
